  ...
  <b-card title="รายการ affiliate">
    ...
    >
      <template slot="table-row" slot-scope="props">
        ...
        <span v-if="props.column.field === 'affiliate_amount'">
          <span class="badge bg-success"> + {{ props.row.aff_amount }}</span>
        </span>
