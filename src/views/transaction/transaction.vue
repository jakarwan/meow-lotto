  ...
  <b-card title="รายการเติมเงิน">
    ...
    >
      <template slot="table-row" slot-scope="props">
        ...
        <span v-if="props.column.field === 'dp_amount'">
          <span class="badge bg-success">{{ numberWithCommas(props.row.amount) }}</span>
        </span>
...
export default {
  ...
  methods: {
    getData() {
      this.isLoading = true;
      HTTP.get("api/admin/transaction", {
        params: {
