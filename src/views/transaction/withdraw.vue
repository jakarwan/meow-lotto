  ...
  <b-card title="รายการถอนออก">
    ...
    >
      <template slot="table-row" slot-scope="props">
        ...
        <span v-if="props.column.field === 'wd_amount'">
          <span class="badge bg-danger">- {{ numberWithCommas(props.row.amount) }}</span>
        </span>
...
export default {
  ...
  methods: {
    ...
    submitTrans(data) {
      console.log(data);
      HTTP.put(`api/admin/withdraw/submit`, {
        id: data.wd_id,
        amount: data.amount,
        userId: data.user_id,
      })
